...
To backup the app you can run the ```backup.sh``` script. This will create a zip file with all the data.

To restore the app you can run the ```restore.sh``` script. This will restore all the data from the given zip.
